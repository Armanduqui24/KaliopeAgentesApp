...
public class DeviceList extends ListActivity {
    ...
    private int initDevicesList() {
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(getApplicationContext(),
                    "Bluetooth no soportado!!", Toast.LENGTH_LONG).show();
            return -1;
        }
        ...
        mArrayAdapter = new ArrayAdapter<String>(getApplicationContext(),
                R.layout.activity_device_list_1);
    ...
    protected void onListItemClick(ListView l, View v, final int position,
        ...
        Toast.makeText(
                ...
                "Conectando con " + btDevices.getItem(position).getName() + ","
            ...
            public void run() {
                try {
                   /* boolean gotuuid = btDevices.getItem(position)
                    ...
                    Log.e("Error de Conexión", ex.toString());
    ...
    private Runnable socketErrorRunnable = new Runnable() {
        ...
        public void run() {
            Toast.makeText(getApplicationContext(),
                    "No se logró establecer la conexión", Toast.LENGTH_SHORT).show();
            mBluetoothAdapter.startDiscovery();
