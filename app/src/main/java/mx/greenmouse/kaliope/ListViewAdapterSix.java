...
public class ListViewAdapterSix extends BaseAdapter
{
    ...
    public ListViewAdapterSix(Activity activity, ArrayList<HashMap> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.list_item_six, null);
