...
public class ListViewAdapterPrecios extends BaseAdapter
{
    public ArrayList<HashMap> list;
    Activity activity;


    public ListViewAdapterPrecios(Activity activity, ArrayList<HashMap> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.list_item_precios, null);
