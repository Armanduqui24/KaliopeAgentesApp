...
public class VariablePassword extends AppCompatActivity{
   ...
   //Constructor
    ...
    //metodo usado para retornar el numero de random y entregarselo al usuario para que lo envie
    ...
    //este metodo podemos obtener este numero para mostrarselo al usuario.
