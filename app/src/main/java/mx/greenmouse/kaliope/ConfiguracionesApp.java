...
public class ConfiguracionesApp {
    ...
    private static final String NOMBRE_FECHA_CLIENTES_CONSULTA1 = "fechaDeLaConsultaDeClientes1";
    private static final String NOMBRE_FECHA_CLIENTES_CONSULTA2 = "fechaDeLaConsultaDeClientes2";
    private static final String NOMBRE_ZONA1 = "nombreDeLaZonaPorVisitar1";
    private static final String NOMBRE_ZONA2 = "nombreDeLaZonaPorVisitar2";
    ...
    public static int getNumeroDePulseraAsignada (Activity activity){
        ...
        // usuario a que carge la tabla de pulceras)
    ...
    private static void setFechaClientesConsulta (Activity activity, String fecha1, String fecha2){
        ...
        SharedPreferences.Editor editor = preferences.edit(); // Declaramos una variable (objeto) de tipo SharedPreferences.Editor, necesario para guardar cambios en el fichero de preferencias.
        editor.putString(NOMBRE_FECHA_CLIENTES_CONSULTA1,fecha1);
        editor.putString(NOMBRE_FECHA_CLIENTES_CONSULTA2,fecha2);
        //editor.commit();//guardamos nuestro fichero
        editor.apply();

    }
    public static String getFechaClientesConsulta1(Activity activity){
        SharedPreferences sharedPreferences =
                activity.getSharedPreferences(NOMBRE_ARCHIVO_CONFIGURACIONES, Context.MODE_PRIVATE);
        ...
        return sharedPreferences.getString(NOMBRE_FECHA_CLIENTES_CONSULTA1,"SinValor");
    }
    public static String getFechaClientesConsulta2(Activity activity){
        SharedPreferences sharedPreferences =
                activity.getSharedPreferences(NOMBRE_ARCHIVO_CONFIGURACIONES, Context.MODE_PRIVATE);
        ...
        return sharedPreferences.getString(NOMBRE_FECHA_CLIENTES_CONSULTA2,"SinValor");
    }
    private static void deleteFechaClientesConsulta (Activity activity){
        SharedPreferences sharedPreferences = activity.getSharedPreferences(NOMBRE_ARCHIVO_CONFIGURACIONES,Context.MODE_PRIVATE);
        sharedPreferences.edit().remove(NOMBRE_FECHA_CLIENTES_CONSULTA1).apply();
        sharedPreferences.edit().remove(NOMBRE_FECHA_CLIENTES_CONSULTA2).apply();

    }



    private static void setZonaVisitar (Activity activity, String nombreZona1, String nombreZona2){
        ...
        SharedPreferences.Editor editor = preferences.edit(); // Declaramos una variable (objeto) de tipo SharedPreferences.Editor, necesario para guardar cambios en el fichero de preferencias.
        editor.putString(NOMBRE_ZONA1,nombreZona1);
        editor.putString(NOMBRE_ZONA2,nombreZona2);
        //editor.commit();//guardamos nuestro fichero
        editor.apply();

    }
    public static String getZonaVisitar1(Activity activity){
        SharedPreferences sharedPreferences =
                activity.getSharedPreferences(NOMBRE_ARCHIVO_CONFIGURACIONES, Context.MODE_PRIVATE);
        ...
        return sharedPreferences.getString(NOMBRE_ZONA1,"SinValor");
    }
    public static String getZonaVisitar2(Activity activity){
        SharedPreferences sharedPreferences =
                activity.getSharedPreferences(NOMBRE_ARCHIVO_CONFIGURACIONES, Context.MODE_PRIVATE);
        ...
        return sharedPreferences.getString(NOMBRE_ZONA2,"SinValor");
    }
    private static void deleteZonaVisitar (Activity activity){
        SharedPreferences sharedPreferences = activity.getSharedPreferences(NOMBRE_ARCHIVO_CONFIGURACIONES,Context.MODE_PRIVATE);
        sharedPreferences.edit().remove(NOMBRE_ZONA1).apply();
        sharedPreferences.edit().remove(NOMBRE_ZONA2).apply();
    ...
    public static void setDatosInicioSesion (Activity activity, JSONArray jsonArray, JSONArray jsonArrayFechaClientes){
        ...
        try {
            ...
            setFechaClientesConsulta(activity,fecha1,fecha2);
            setZonaVisitar(activity,zona1,zona2);
